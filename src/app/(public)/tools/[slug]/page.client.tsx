...
const toolComponents: { [key: string]: React.ComponentType } = {
  ...
  'ai-voice-cloning': dynamic(() => import('@/components/tools/AiVoiceCloning').then(mod => mod.AiVoiceCloning), { loading: () => <LoadingComponent /> }),
  ...
  'image-background-remover': dynamic(() => import('@/components/tools/ImageBackgroundRemover').then(mod => mod.ImageBackgroundRemover), { loading: () => <LoadingComponent /> }),
