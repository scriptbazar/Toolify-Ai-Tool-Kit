...
import { deletePost } from '@/ai/flows/blog-management';
...
export function AllPostsClient({ initialPosts }: AllPostsClientProps) {
                                    ...
                                    <AlertDialog>
                                        ...
                                        <AlertDialogContent>
                                            <AlertDialogHeader>
                                                ...
                                                <AlertDialogDescription>
                                                    This action will move the post to the trash. It will not be permanently deleted immediately.
                                                </AlertDialogDescription>
                                            </AlertDialogHeader>
                                            <AlertDialogFooter>
