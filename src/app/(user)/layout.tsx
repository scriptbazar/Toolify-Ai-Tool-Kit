...
export default function UserPanelLayout({
  ...
  const navLinks = [
    ...
    { href: '/manage-subscription', icon: CreditCard, label: 'Manage Subscription' },
    { href: '/payment-history', icon: History, label: 'Payment History' },
    { href: '/settings', icon: Settings, label: 'Settings' },
    { href: '/usage-history', icon: History, label: 'Usage History' },
    { href: '/login-history', icon: ShieldCheck, label: 'Login History' },
    { href: '/my-media', icon: ImageIcon, label: 'My Media' },
    { href: '/refer-a-friend', icon: UserPlus, label: 'Refer a Friend' },
    { href: '/my-tickets', icon: Ticket, label: 'My Tickets' },
    { href: '/create-ticket', icon: PlusCircle, label: 'Create a Ticket' },
    { href: '/community-chat', icon: MessageSquare, label: 'Community Chat' },
  ];
