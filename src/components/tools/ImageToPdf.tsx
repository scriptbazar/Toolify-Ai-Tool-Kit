        ...
        >
            ...
            >
                ...
                <div className="flex flex-col items-center justify-center h-full">
                    ...
                    <h3 className="text-lg font-semibold">{file ? file.name : "Click or drag image file to upload"}</h3>
                    <p className="text-sm text-muted-foreground">Your image will be converted to a PDF document.</p>
                </div>
            </CardContent>
       </Card>
