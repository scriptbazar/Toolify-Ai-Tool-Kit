...
export function ImageBackgroundRemover() {
  ...
  const handleRemoveBackground = async () => {
    ...
    try {
        ...
        toast({ title: 'Background Removed!', description: 'The AI has processed your image.'});
    } catch (error: any) {
        toast({ title: "Processing Failed", description: error.message || 'Could not remove the background.', variant: 'destructive'});
    } finally {
        setIsLoading(false);
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
          ...
          {resultImage && (
             <div className="space-y-2">
                <Label>Result with Background Removed</Label>
                 <div className="aspect-square w-full bg-muted rounded-lg flex items-center justify-center overflow-hidden" style={{ backgroundImage: 'url("data:image/svg+xml,%3csvg xmlns=\'http://www.w3.org/2000/svg\' viewBox=\'0 0 32 32\' width=\'32\' height=\'32\' fill=\'none\'%3e%3cpath d=\'M0 0h16v16H0z\' fill=\'%23f0f0f0\'/%3e%3cpath d=\'M16 16h16v16H16z\' fill=\'%23f0f0f0\'/%3e%3c/svg%3e")' }}>
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 pt-4 border-t">
        <div className="flex gap-2">
           <Button onClick={handleRemoveBackground} disabled={isLoading || !imageFile}>
