...
const cropMeeshoLabel = async (pdfDoc: PDFDocument): Promise<PDFDocument> => {
...
export function MeeshoShippingLabelCropper() {
  return (
    <ShippingLabelCropper
      platform="Meesho"
      description="Upload the standard PDF label you downloaded from Meesho."
      cropFunction={cropMeeshoLabel}
    />
  );
}
