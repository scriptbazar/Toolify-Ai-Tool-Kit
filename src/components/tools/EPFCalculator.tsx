...
export function EPFCalculator() {
    ...
    const calculateEPF = () => {
        ...
        for (let year = p_age; year < r_age; year++) {
            ...
            const interest = (p_balance + annualContribution) * p_rate;
            p_balance += annualContribution + interest;
            p_salary *= (1 + p_increase);
        }

        setResult({
            totalInvestment,
            interestEarned: p_balance - totalInvestment,
            maturityValue: p_balance
        });
    };
        ...
        <div className="space-y-6">
            <Card>
                ...
                <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div className="space-y-2"><Label>Annual Salary Increase (%)</Label><Input type="number" value={salaryIncrease} onChange={e => setSalaryIncrease(e.target.value)} /></div>
                </CardContent>
            </Card>
