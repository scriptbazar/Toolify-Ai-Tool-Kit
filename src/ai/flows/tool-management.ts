...
const initialTools: Omit<Tool, 'id' | 'slug' | 'createdAt'>[] = [
    ...
    { name: 'YouTube Channel Banner Downloader', description: '🖼️ Download high-quality YouTube channel banners by providing the channel URL. A great tool for designers and marketers.', icon: 'Download', category: 'video', plan: 'Free', isNew: true, status: 'Coming Soon', howToUse: ['Paste the YouTube channel URL.', 'Click "Fetch Banner".', 'Preview and download the banner in the highest available resolution.'] },
