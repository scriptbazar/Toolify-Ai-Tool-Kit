...
const initialTools: Omit<Tool, 'id' | 'slug' | 'createdAt'>[] = [
    ...
    { name: 'AI Image Generator', description: 'Create stunning, unique, and high-quality images from simple text descriptions using advanced AI models.', icon: 'ImageIcon', category: 'ai', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Write a descriptive prompt of the image you want to create.', 'Click the "Generate Image" button.', 'The AI will generate an image based on your prompt.', 'You can then download the generated image.'] },
    ...
    { name: 'AI Code Generator', description: 'Generate high-quality code snippets in any language with detailed setup instructions and explanations.', icon: 'Terminal', category: 'ai', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Describe what you want to build with code.', 'Select the programming language.', 'Click "Generate Code".', 'The AI will provide the code, setup instructions, and a detailed explanation.'] },
    ...
    { name: 'Image Background Remover', description: 'Automatically remove the background from any image with a single click using advanced AI.', icon: 'Scissors', category: 'ai', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Upload an image with a clear subject (person, object, etc.).', 'Click the "Remove Background" button.', 'The AI will process the image and provide a version with a transparent background.', 'Click "Download" to save the result as a PNG file.'] },
    ...
    { name: 'GPA to Percentage Converter', description: 'Convert your Grade Point Average (GPA) into a percentage to understand your academic standing.', icon: 'Calculator', category: 'calculator', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Enter your GPA score.', 'Enter the maximum GPA scale (e.g., 4.0 or 10.0).', 'Click "Convert to Percentage".', 'Your equivalent percentage will be displayed.'] },
    ...
    { name: 'NSDL PAN Card Photo and Signature Resizer', description: 'Resize your photo and signature to the exact dimensions and file size required for NSDL PAN card applications.', icon: 'Crop', category: 'image', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Upload your photo and signature images separately.', 'The tool will automatically resize them to the NSDL-specified dimensions and file size.', 'Download the perfectly formatted images.'] },
    { name: 'UTI PAN Card Photo and Signature Resizer', description: 'Resize your photo and signature to meet the specific requirements for UTI PAN card applications online.', icon: 'Crop', category: 'image', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Upload your photo and signature images.', 'The tool will automatically crop and resize them according to UTI guidelines.', 'Download the ready-to-upload images.'] },
    ...
    { name: 'Universal File Converter', description: 'Convert your files from one format to another across a wide range of categories like documents, images, and more.', icon: 'FileCog', category: 'dev', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Upload your source file.', 'Select the target output format from the extensive list.', 'Click the "Convert" button.', 'Download your newly converted file.'] },
    ...
    { name: 'Morse to Text Translator', description: 'Translate Morse code signals (dots and dashes) into plain, readable text.', icon: 'MessageSquare', category: 'text', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Enter your Morse code into the input box, using dots (.) and dashes (-).', 'The translated text will appear in the output box automatically.'] },
    { name: 'Text to Morse Code', description: 'Translate plain text into universally recognized Morse code signals.', icon: 'MessageSquare', category: 'text', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Enter your text in the input box.', 'The corresponding Morse code will be generated in the output box automatically.'] },
    { name: 'Cryptocurrency Converter', description: 'Convert between different cryptocurrencies and traditional fiat currencies with real-time rates.', icon: 'Bitcoin', category: 'calculator', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Enter the amount you want to convert.', 'Select the source currency (e.g., BTC) and the target currency (e.g., USD).', 'The tool will display the converted amount based on the latest exchange rates.'] },
    { name: 'Barcode Generator', description: 'Generate various types of barcodes, such as UPC, EAN, and Code 128, for your products or inventory.', icon: 'Barcode', category: 'dev', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Select the barcode type (e.g., Code 128, EAN-13).', 'Enter the data you want to encode.', 'Click "Generate Barcode".', 'Download the barcode as an image file.'] },
    ...
    { name: 'Credit Card Interest Calculator', description: 'Calculate the interest on your credit card balance to better understand and manage your debt.', icon: 'CreditCard', category: 'calculator', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Enter your credit card balance.', 'Input the Annual Percentage Rate (APR).', 'Specify your monthly payment.', 'The tool will show you how long it takes to pay off and the total interest paid.'] },
    ...
    { name: 'PPT to PDF', description: 'Convert your PowerPoint presentations (.ppt, .pptx) into shareable PDF documents.', icon: 'FileBadge2', category: 'pdf', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Upload your PowerPoint presentation file.', 'Click "Convert to PDF".', 'Your presentation will be downloaded as a PDF.'] },
    ...
    { name: 'Robots.txt Generator', description: 'Generate a robots.txt file to guide search engine crawlers on which parts of your site to index or ignore.', icon: 'Bot', category: 'seo', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Use the options to allow or disallow different user-agents (bots).', 'Add sitemap URLs if you have them.', 'The tool will generate the robots.txt content for you to copy.'] },
    { name: 'XML Sitemap Generator', description: 'Create an XML sitemap for your website to help search engines like Google better discover and index all your pages.', icon: 'FileCode', category: 'seo', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Enter your website\'s URL.', 'The tool will crawl your site to find all the pages.', 'Click "Generate Sitemap" to create the sitemap.xml file.', 'Download the file and upload it to your website\'s root directory.'] },
    { name: 'Favicon Checker', description: 'Check if a website has a favicon installed and preview how it looks in a browser tab.', icon: 'Image', category: 'seo', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Enter the URL of the website you want to check.', 'Click "Check Favicon".', 'The tool will display the website\'s favicon if it exists.'] },
    { name: 'Keyword Density Checker', description: 'Analyze the keyword density of your text content to optimize for SEO and avoid keyword stuffing.', icon: 'Key', category: 'seo', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Paste your article or text into the text area.', 'Click "Analyze Text".', 'The tool will show you a table of the most frequent keywords and their density percentage.'] },
    ...
    { name: 'Time Zone Converter', description: 'Convert times between different time zones around the world to coordinate meetings and events.', icon: 'Clock', category: 'calculator', plan: 'Free', isNew: true, status: 'Active', howToUse: ['The tool displays the current time in several default time zones.', 'You can add more time zones from the dropdown list.', 'The times will update in real-time.'] },
    { name: 'Unix Timestamp Converter', description: 'Convert Unix timestamps to human-readable dates and vice-versa for development and data analysis.', icon: 'Timer', category: 'dev', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Enter a Unix timestamp to see the human-readable date.', 'Alternatively, use the date picker to select a date and see its Unix timestamp.'] },
    { name: 'HTML Minifier', description: 'Minify your HTML code to reduce file size, remove whitespace, and improve website loading performance.', icon: 'FileCode', category: 'dev', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Paste your HTML code into the "Original HTML" box.', 'Click the "Minify HTML" button.', 'The minified code will appear in the "Minified HTML" box.', 'Click "Copy" to use the minified code.'] },
    { name: 'JavaScript Minifier', description: 'Minify your JavaScript code to decrease file size and speed up your website or application.', icon: 'FileCode', category: 'dev', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Paste your JavaScript code into the "Original JavaScript" box.', 'Click the "Minify JS" button.', 'The minified code will appear in the "Minified JavaScript" box.', 'Click "Copy" to use the minified code.'] },
    { name: 'SQL Formatter', description: 'Format and beautify your SQL queries to make them more readable and easier to debug.', icon: 'Database', category: 'dev', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Paste your unformatted SQL query into the text area.', 'Choose your desired formatting options (e.g., indentation).', 'Click "Format SQL".', 'Copy the clean, formatted SQL query.'] },
    { name: 'YouTube Video Downloader', description: 'Download YouTube videos in various qualities and formats, including MP4 and MP3.', icon: 'Youtube', category: 'video', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Paste the URL of the YouTube video.', 'The tool will fetch available download links for different qualities.', 'Click on your desired quality to start the download.'] },
    { name: 'X (Twitter) Video Downloader', description: 'Download videos from posts on X (formerly Twitter) by simply pasting the post URL.', icon: 'Twitter', category: 'video', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Copy the URL of the tweet containing the video.', 'Paste the URL into the input field.', 'Click "Download Video" to save the video file.'] },
    { name: 'Instagram Video Downloader', description: 'Download videos and reels from public Instagram posts directly to your device.', icon: 'Instagram', category: 'video', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Copy the URL of the Instagram post, Reel, or Story.', 'Paste the URL into the input field.', 'Click "Download Video" to get the video file.'] },
    { name: 'Threads Video Downloader', description: 'Download videos from Threads posts by providing the URL of the post.', icon: 'AtSign', category: 'video', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Copy the URL of the Threads post with the video.', 'Paste the URL into the tool.', 'Click "Download Video" to save the video.'] },
    { name: 'LinkedIn Video Downloader', description: 'Download videos from public LinkedIn posts to save for offline viewing or sharing.', icon: 'Linkedin', category: 'video', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Copy the URL of the LinkedIn post containing the video.', 'Paste the URL into the input field.', 'Click the "Download Video" button.'] },
    { name: 'Pinterest Video Downloader', description: 'Download videos from Pinterest pins to save your favorite ideas and tutorials.', icon: 'BookImage', category: 'video', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Copy the URL of the Pinterest pin that has the video.', 'Paste the URL into the download tool.', 'Click "Download Video" to save it.'] },
