...
const initialTools: Omit<Tool, 'id' | 'slug' | 'createdAt'>[] = [
    ...
    { name: 'PRN to PDF', description: '📄 Convert PRN files, commonly generated by the "Print to File" option, into standard, viewable PDF documents.', icon: 'FileText', category: 'pdf', plan: 'Free', isNew: true, status: 'Disabled', howToUse: ['Upload your PRN file.', 'Click "Convert to PDF".', 'Download the converted PDF file.'] },
    ...
    { name: 'YT Banner Downloader', description: '🖼️ Download high-quality YouTube channel banners by providing the channel URL. A great tool for designers and marketers.', icon: 'Download', category: 'video', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Paste the YouTube channel URL.', 'Click "Fetch Banner".', 'Preview and download the banner in the highest available resolution.'] },
