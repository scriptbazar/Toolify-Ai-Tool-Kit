...
const initialTools: Omit<Tool, 'id' | 'slug' | 'createdAt'>[] = [
    ...
    { name: 'Barcode Scanner', description: '📷 Scan a barcode from an image file to reveal its content. Supports various barcode formats like UPC, EAN, and Code 128.', icon: 'ScanLine', category: 'image', plan: 'Free', isNew: true, status: 'Coming Soon', howToUse: ['Upload an image file containing a barcode.', 'The tool will automatically scan the image.', 'The decoded data from the barcode will be displayed below.'] },
    ...
    { name: 'YT Banner Downloader', description: '🖼️ Download high-quality YouTube channel banners by providing the channel URL. A great tool for designers and marketers.', icon: 'Download', category: 'video', plan: 'Free', isNew: true, status: 'Coming Soon', howToUse: ['Paste the YouTube channel URL.', 'Click "Fetch Banner".', 'Preview and download the banner in the highest available resolution.'] },
    { name: 'YT Logo Downloader', description: '👤 Download the logo or profile picture of any YouTube channel in high resolution. Simply provide the channel URL.', icon: 'UserCircle', category: 'video', plan: 'Free', isNew: true, status: 'Coming Soon', howToUse: ['Paste the YouTube channel URL.', 'Click "Fetch Logo".', 'Download the channel\'s profile picture.'] },
