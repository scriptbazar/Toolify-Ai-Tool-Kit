...
const initialTools: Omit<Tool, 'id' | 'slug' | 'createdAt'>[] = [
    ...
    { name: 'Excel to PDF', description: 'Convert your Microsoft Excel spreadsheets (.xls, .xlsx) into professional-looking PDF documents.', icon: 'FileSpreadsheet', category: 'pdf', plan: 'Free', isNew: true, status: 'Active', howToUse: [] },
    ...
    { name: 'Image to PDF', description: 'Convert your JPG, PNG, and other image files into a single, easy-to-share PDF document.', icon: 'FileImage', category: 'pdf', plan: 'Free', isNew: true, status: 'Active', howToUse: [] },
    ...
    { name: 'YouTube Channel Banner Downloader', description: 'Download the high-quality banner image (channel art) from any YouTube channel.', icon: 'Download', category: 'video', plan: 'Free', isNew: true, status: 'Active', howToUse: [] },
    { name: 'YouTube Channel Logo Downloader', description: 'Download the high-resolution profile picture or logo from any YouTube channel.', icon: 'Download', category: 'video', plan: 'Free', isNew: true, status: 'Active', howToUse: [] },
    ...
    { name: 'PRN to PDF', description: 'Convert PRN files, commonly generated by the "Print to File" option, into standard PDF documents.', icon: 'FileText', category: 'pdf', plan: 'Free', isNew: true, status: 'Active', howToUse: [] },
    ...
    { name: 'Morse to Text Translator', description: 'Translate Morse code back into readable text.', icon: 'MessageSquare', category: 'miscellaneous', isNew: true, status: 'Active', howToUse: [] },
    { name: 'Text Encryption and Decryption', description: 'Encrypt and decrypt your text using various algorithms for security.', icon: 'Key', category: 'dev', plan: 'Pro', isNew: true, status: 'Active', howToUse: [] },
    { name: 'GPA to Percentage Converter', description: 'Convert your GPA score back into a percentage.', icon: 'Calculator', category: 'calculator', isNew: true, status: 'Active', howToUse: [] },
    ...
    { name: 'Text to Morse Code', description: 'Convert text to Morse code.', icon: 'MessageSquare', category: 'miscellaneous', isNew: true, status: 'Active', howToUse: [] },
