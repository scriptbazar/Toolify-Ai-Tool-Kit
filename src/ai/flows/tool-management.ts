...
const initialTools: Omit<Tool, 'id' | 'slug' | 'createdAt'>[] = [
    ...
    { name: 'Website Word Counter', description: 'Check the size of any webpage.', icon: 'FileSearch', category: 'seo', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Enter the URL of the website you want to analyze.', 'The tool will fetch the page and count the total words on it.'] },
