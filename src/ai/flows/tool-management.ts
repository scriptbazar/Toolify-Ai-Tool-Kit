...
const initialTools: Omit<Tool, 'id' | 'slug' | 'createdAt'>[] = [
    ...
    { name: 'Robots Txt Generator', description: '🤖 Create a robots.txt file to guide search engine crawlers. Set rules for different bots and include your sitemap easily.', icon: 'FileCode', category: 'seo', plan: 'Pro', isNew: true, status: 'Active', howToUse: ["Select a default policy (Allow or Block all).", "Add specific rules for different user-agents (e.g., Googlebot).", "Enter the full URL to your sitemap.", "The robots.txt content is generated live for you to copy or download."] },
