...
const initialTools: Omit<Tool, 'id' | 'slug' | 'createdAt'>[] = [
    ...
    { name: 'Base64 Encoder/Decoder', description: 'Encode text or files to Base64 and decode from Base64 format, essential for data transmission and web development.', icon: 'Package', category: 'dev', plan: 'Free', isNew: true, status: 'Active' },
    { name: 'Binary to Text', description: 'Convert binary code (sequences of 0s and 1s) back into human-readable text characters.', icon: 'Binary', category: 'dev', plan: 'Free', isNew: true, status: 'Active' },
    ...
    { name: 'Text to Binary', description: 'Convert any text into its corresponding binary code representation.', icon: 'Binary', category: 'dev', plan: 'Free', isNew: true, status: 'Active' },
