...
const initialTools: Omit<Tool, 'id' | 'slug' | 'createdAt'>[] = [
    ...
    { name: 'PinterestVideoDownloader', description: 'Download videos from Pinterest.', icon: 'BookImage', category: 'video', plan: 'Pro', isNew: true, status: 'Active', howToUse: [] },
    { name: 'LinkedinVideoDownloader', description: 'Download videos from LinkedIn.', icon: 'Linkedin', category: 'video', plan: 'Pro', isNew: true, status: 'Active', howToUse: [] },
    { name: 'PptToPdf', description: 'Convert PowerPoint presentations to PDF.', icon: 'FileText', category: 'pdf', plan: 'Pro', isNew: true, status: 'Active', howToUse: [] },
    { name: 'TextToMorseCode', description: 'Convert text to Morse code.', icon: 'MessageSquare', category: 'miscellaneous', plan: 'Free', isNew: true, status: 'Active', howToUse: [] },
    { name: 'YoutubeVideoDownloader', description: 'Download videos from YouTube in various formats and qualities.', icon: 'Download', category: 'video', plan: 'Pro', isNew: true, status: 'Active', howToUse: [] },
    { name: 'InstagramVideoDownloader', description: 'Download videos from Instagram.', icon: 'Instagram', category: 'video', plan: 'Pro', isNew: true, status: 'Active', howToUse: [] },
    { name: 'XVideoDownloader', description: 'Download videos from X (formerly Twitter).', icon: 'Twitter', category: 'video', plan: 'Pro', isNew: true, status: 'Active', howToUse: [] },
    { name: 'ThreadsVideoDownloader', description: 'Download videos from Threads.', icon: 'AtSign', category: 'video', plan: 'Pro', isNew: true, status: 'Active', howToUse: [] },
    { name: 'LoanCalculator', description: 'Calculate loan payments, interest, and amortization schedules.', icon: 'Landmark', category: 'calculator', plan: 'Pro', isNew: true, status: 'Active', howToUse: [] },
    { name: 'SqlFormatter', description: 'Format and beautify your SQL queries for better readability.', icon: 'Database', category: 'dev', plan: 'Free', isNew: true, status: 'Active', howToUse: [] },
    { name: 'XmlSitemapGenerator', description: 'Generate an XML sitemap for your website to improve SEO indexing.', icon: 'FileCode', category: 'seo', plan: 'Pro', isNew: true, status: 'Active', howToUse: [] },
    { name: 'WordToPdf', description: 'Convert Microsoft Word documents to PDF format.', icon: 'FileText', category: 'pdf', plan: 'Pro', isNew: true, status: 'Active', howToUse: [] },
    { name: 'PdfToJpg', description: 'Convert PDF pages to high-quality JPG images.', icon: 'FileImage', category: 'pdf', plan: 'Pro', isNew: true, status: 'Active', howToUse: [] },
    { name: 'PdfToWord', description: 'Convert PDF documents to editable Microsoft Word files.', icon: 'FileText', category: 'pdf', plan: 'Pro', isNew: true, status: 'Active', howToUse: [] },
    { name: 'MorseToTextTranslator', description: 'Translate Morse code back into readable text.', icon: 'MessageSquare', category: 'miscellaneous', plan: 'Free', isNew: true, status: 'Active', howToUse: [] },
];
