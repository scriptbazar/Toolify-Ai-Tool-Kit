...
const initialTools: Omit<Tool, 'id' | 'slug' | 'createdAt'>[] = [
    ...
    { name: 'AdMob Revenue Calculator', description: 'Estimate your potential AdMob earnings.', icon: 'Calculator', category: 'calculator', plan: 'Free', isNew: true, status: 'Active' },
    { name: 'AdSense Revenue Calculator', description: 'Estimate your potential AdSense earnings.', icon: 'Calculator', category: 'calculator', plan: 'Free', isNew: true, status: 'Active' },
