...
const initialTools: Omit<Tool, 'id' | 'slug' | 'createdAt'>[] = [
    { name: 'Case Converter', description: 'Convert text between different letter cases (e.g., uppercase, lowercase, title case).', icon: 'CaseSensitive', category: 'text', plan: 'Free', isNew: false, status: 'Coming Soon' },
    { name: 'Word Counter', description: 'Count words, characters, sentences, and paragraphs in your text.', icon: 'Calculator', category: 'text', plan: 'Free', isNew: false, status: 'Coming Soon' },
    { name: 'Lorem Ipsum Generator', description: 'Generate placeholder text in various lengths and formats.', icon: 'FileText', category: 'text', plan: 'Free', isNew: false, status: 'Coming Soon' },
    { name: 'Password Generator', description: 'Create strong, secure, and customizable passwords.', icon: 'KeyRound', category: 'dev', plan: 'Free', isNew: false, status: 'Coming Soon' },
    { name: 'JSON Formatter', description: 'Format, validate, and beautify your JSON data for readability.', icon: 'Braces', category: 'dev', plan: 'Free', isNew: false, status: 'Coming Soon' },
    { name: 'BMI Calculator', description: 'Calculate your Body Mass Index to assess your weight status.', icon: 'HeartPulse', category: 'calculator', plan: 'Free', isNew: false, status: 'Coming Soon' },
    { name: 'Text to Speech', description: 'Convert written text into natural-sounding spoken audio in various voices.', icon: 'Volume2', category: 'ai', plan: 'Pro', isNew: true, status: 'Coming Soon' },
    { name: 'Speech to Text', description: 'Transcribe audio files into written text.', icon: 'Voicemail', category: 'ai', plan: 'Pro', isNew: true, status: 'Coming Soon' },
    { name: 'PDF Merger', description: 'Combine multiple PDF files into a single, organized document.', icon: 'FilePlus2', category: 'pdf', plan: 'Pro', isNew: false, status: 'Coming Soon' },
    ...
    { name: 'Unit Converter', description: 'Convert between different units of measurement (length, mass, temp, etc.).', icon: 'Ruler', category: 'calculator', plan: 'Free', isNew: false, status: 'Coming Soon' },
    { name: 'Color Picker', description: 'Pick colors from an interactive color wheel or your screen.', icon: 'Pipette', category: 'image', plan: 'Free', isNew: false, status: 'Coming Soon' },
    { name: 'Text Repeater', description: 'Repeat a piece of text with optional new lines.', icon: 'Repeat', category: 'text', plan: 'Free', isNew: false, status: 'Coming Soon' },
    { name: 'Prompt Generator', description: 'Generate creative prompts for AI models based on your topic.', icon: 'Lightbulb', category: 'ai', plan: 'Free', isNew: true, status: 'Coming Soon' },
    { name: 'AI Blog Post Writer', description: 'Generate a complete, SEO-friendly blog post from just a topic.', icon: 'PenSquare', category: 'ai', plan: 'Pro', isNew: true, status: 'Coming Soon' },
    { name: 'AI Content Summarizer', description: 'Summarize long articles, documents, or texts into concise points.', icon: 'AlignLeft', category: 'ai', plan: 'Pro', isNew: true, status: 'Coming Soon' },
    { name: 'AI Code Assistant', description: 'Get help with writing, debugging, and explaining code snippets.', icon: 'Code', category: 'ai', plan: 'Pro', isNew: true, status: 'Coming Soon' },
    { name: 'AI Email Composer', description: 'Generate professional emails for various purposes based on your key points.', icon: 'Mail', category: 'ai', plan: 'Pro', isNew: true, status: 'Coming Soon' },
    { name: 'AI Image Generator', description: 'Create stunning, unique images from text descriptions.', icon: 'ImageIcon', category: 'ai', plan: 'Pro', isNew: true, status: 'Coming Soon' },
    { name: 'AI Product Description Writer', description: 'Craft persuasive and engaging descriptions for your e-commerce products.', icon: 'ShoppingCart', category: 'ai', plan: 'Pro', isNew: true, status: 'Coming Soon' },
    { name: 'AI Story Generator', description: 'Craft compelling stories in various genres from a simple prompt.', icon: 'BookOpen', category: 'ai', plan: 'Pro', isNew: true, status: 'Coming Soon' },
    { name: 'AI Tweet Generator', description: 'Generate engaging tweets and thread ideas for social media.', icon: 'Twitter', category: 'ai', plan: 'Pro', isNew: true, status: 'Coming Soon' },
    { name: 'AI Voice Cloning', description: 'Create a digital clone of your voice and generate speech in your own accent.', icon: 'Voicemail', category: 'ai', plan: 'Pro', isNew: true, status: 'Coming Soon' },
    { name: 'AI Story Visualizer', description: 'Analyzes your story scene-by-scene and generates powerful image prompts for each scene.', icon: 'Clapperboard', category: 'ai', plan: 'Pro', isNew: true, status: 'Coming Soon' },
    { name: 'AI Code Generator', description: 'Generate high-quality code snippets in any language with setup instructions and explanations.', icon: 'Terminal', category: 'ai', plan: 'Pro', isNew: true, status: 'Coming Soon' },
    { name: 'AI Rewriter', description: 'Rewrite your text to improve clarity, change the tone, or fix grammar.', icon: 'FilePenLine', category: 'ai', plan: 'Pro', isNew: true, status: 'Coming Soon' },
    { name: 'Add Watermark to PDF', description: 'Add a text or image watermark to your PDF documents.', icon: 'Fingerprint', category: 'pdf', plan: 'Pro', isNew: true, status: 'Coming Soon' },
    { name: 'Age Calculator', description: 'Calculate age from date of birth.', icon: 'Gift', category: 'calculator', plan: 'Free', isNew: false, status: 'Coming Soon' },
    { name: 'Amazon Shipping Label Cropper', description: 'Effortlessly crop your standard 8.5x11 inch Amazon FBA shipping labels to a perfect 4x6 inch format, ideal for thermal printers. Save time and label costs.', icon: 'FileUp', category: 'ecommerce', plan: 'Free', isNew: true, status: 'Coming Soon' },
    { name: 'Myntra Shipping Label Cropper', description: 'Quickly convert your standard Myntra shipping labels into a 4x6 inch thermal printer-friendly format. Streamline your packing process with one click.', icon: 'Crop', category: 'ecommerce', plan: 'Free', isNew: true, status: 'Coming Soon' },
    ...
    { name: 'Binary to Text', description: 'Convert binary code (sequences of 0s and 1s) back into human-readable text characters.', icon: 'Binary', category: 'dev', plan: 'Free', isNew: true, status: 'Coming Soon' },
    ...
    { name: 'Text to Binary', description: 'Convert any text into its corresponding binary code representation.', icon: 'Binary', category: 'dev', plan: 'Free', isNew: true, status: 'Coming Soon' },
    { name: 'Reverse Text', description: 'Reverse your text in various ways (by word, all characters, etc.).', icon: 'ArrowLeftRight', category: 'text', plan: 'Free', isNew: true, status: 'Coming Soon' },
    { name: 'Remove Extra Spaces', description: 'Clean up your text by removing extra spaces and line breaks.', icon: 'Eraser', category: 'text', plan: 'Free', isNew: true, status: 'Coming Soon' },
    { name: 'Find and Replace', description: 'Quickly find and replace words or phrases in your text.', icon: 'SearchCode', category: 'text', plan: 'Free', isNew: true, status: 'Coming Soon' },
    { name: 'Random Word Generator', description: 'Generate random words for creative writing, games, or brainstorming.', icon: 'Shuffle', category: 'text', plan: 'Free', isNew: true, status: 'Coming Soon' },
    { name: 'Rotate Image', description: 'Rotate an image by 90, 180, or 270 degrees.', icon: 'RotateCw', category: 'image', plan: 'Free', isNew: true, status: 'Coming Soon' },
    { name: 'PNG to JPG', description: 'Convert PNG images to JPG format.', icon: 'FileImage', category: 'image', plan: 'Free', isNew: true, status: 'Coming Soon' },
    { name: 'JPG to PNG', description: 'Convert JPG images to PNG format.', icon: 'FileImage', category: 'image', plan: 'Free', isNew: true, status: 'Coming Soon' },
    { name: 'Image to Base64', description: 'Convert an image to a Base64 string.', icon: 'Code', category: 'image', plan: 'Free', isNew: true, status: 'Coming Soon' },
    { name: 'Image Resizer', description: 'Resize image dimensions by pixels or percentage.', icon: 'Scaling', category: 'image', plan: 'Free', isNew: true, status: 'Coming Soon' },
    { name: 'Image Background Remover', description: 'Automatically remove the background from your images with a single click.', icon: 'Scissors', category: 'ai', plan: 'Pro', isNew: true, status: 'Coming Soon' },
    { name: 'AdMob Revenue Calculator', description: 'Estimate your potential AdMob earnings based on DAU, impressions, and eCPM.', icon: 'Calculator', category: 'calculator', plan: 'Free', isNew: true, status: 'Coming Soon' },
    { name: 'AdSense Revenue Calculator', description: 'Estimate your potential AdSense earnings based on page views, CTR, and CPC.', icon: 'Calculator', category: 'calculator', plan: 'Free', isNew: true, status: 'Coming Soon' },
    ...
    { name: 'Image Cropper', description: 'Crop images to your desired dimensions.', icon: 'Crop', category: 'image', plan: 'Free', isNew: true, status: 'Coming Soon' },
    { name: 'Image Compressor', description: 'Reduce the file size of your images.', icon: 'FileArchive', category: 'image', plan: 'Pro', isNew: true, status: 'Coming Soon' },
    ...
    { name: 'Image Converter', description: 'Convert images between different formats like PNG, JPG, WEBP.', icon: 'FileImage', category: 'image', plan: 'Free', isNew: true, status: 'Coming Soon' },
