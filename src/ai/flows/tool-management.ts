...
const initialTools: Omit<Tool, 'id' | 'slug' | 'createdAt'>[] = [
    ...
    { name: 'JSON Prompt Generator', description: 'Generate detailed, structured prompts in JSON format for consistent and predictable AI outputs.', icon: 'Braces', category: 'ai', plan: 'Free', isNew: true, isToolOfTheWeek: false, status: 'Active', howToUse: ['Enter a topic or keywords.', 'Select a category (e.g., Image, App).', 'Choose the style and detail level.', 'Click "Generate JSON Prompt" to get a structured JSON prompt.'] },
    ...
    { name: 'AI Image Quality Enhancer', description: 'Upscale and enhance the quality and resolution of your images using powerful AI.', icon: 'Sparkles', category: 'ai', plan: 'Pro', isNew: true, isToolOfTheWeek: false, status: 'Active', howToUse: ['Upload a low-resolution or blurry image.', 'Select the enhancement factor (e.g., 2x, 4x).', 'Click "Enhance Image".', 'The AI will upscale and sharpen your image, which you can then download.'] },
    ...
    { name: 'Loan Calculator', description: 'Calculate your monthly loan payments, total payment, and total interest for mortgages, car loans, or personal loans.', icon: 'Calculator', category: 'calculator', plan: 'Free', isNew: true, isToolOfTheWeek: false, status: 'Active', howToUse: ['Enter the total loan amount.', 'Input the annual interest rate.', 'Specify the loan term in years or months.', 'Click "Calculate" to see your monthly payment and total interest.'] },
