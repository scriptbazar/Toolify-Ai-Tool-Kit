...
const initialTools: Omit<Tool, 'id' | 'slug' | 'createdAt'>[] = [
    ...
    { name: 'Unit Converter', description: 'Convert between various units of measurement for length, mass, temperature, and more with this versatile tool.', icon: 'Ruler', category: 'calculator', isNew: false, status: 'Active', howToUse: ['Select the type of conversion (e.g., Length, Mass).', 'Enter the value you want to convert in the "From" field.', 'Select the "From" and "To" units from the dropdown menus.', 'The converted value will automatically appear in the "To" field.'] },
    ...
    { name: 'Age Calculator', description: 'Calculate your exact age in years, months, and days from your date of birth instantly.', icon: 'Gift', category: 'calculator', isNew: false, status: 'Active', howToUse: ['Select your date of birth using the calendar.', 'The tool will automatically calculate and display your age in years, months, and days.', 'It will also show how many days are left until your next birthday.'] },
    ...
    { name: 'IFSC Code to Bank Details', description: 'Get complete bank branch details instantly from an Indian Financial System Code (IFSC).', icon: 'Landmark', category: 'dev', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Enter a valid 11-character IFSC code.', 'Click the "Find Bank Details" button.', 'The tool will display the bank name, branch, address, and other available details.'] },
    ...
    { name: 'Marks to Percentage Calculator', description: 'Convert your exam marks or grades into a standardized percentage score quickly and easily.', icon: 'Calculator', category: 'calculator', isNew: true, status: 'Active', howToUse: ['Enter the marks you obtained.', 'Enter the total possible marks for the exam.', 'Click "Calculate Percentage".', 'The tool will display your percentage score.'] },
    ...
    { name: 'Percentage to CGPA Converter', description: 'Convert your overall percentage into a CGPA score on various scales (e.g., 4.0, 10.0).', icon: 'Calculator', category: 'calculator', isNew: true, status: 'Active', howToUse: ['Enter your total percentage.', 'Select the target CGPA scale (e.g., 10-point scale).', 'Click "Convert to CGPA".', 'Your equivalent CGPA will be displayed.'] },
    ...
    { name: 'PRN to PDF', description: 'Convert PRN files, commonly generated by the "Print to File" option, into standard PDF documents.', icon: 'FileText', category: 'pdf', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Upload your PRN file.', 'Click "Convert to PDF".', 'Download the converted PDF file.'] },
    ...
    { name: 'Currency Converter', description: 'Convert between different world currencies with up-to-date exchange rates for your travel or business needs.', icon: 'Coins', category: 'calculator', isNew: true, status: 'Active', howToUse: ['Enter the amount you wish to convert.', 'Select the "From" and "To" currencies from the dropdown lists.', 'The converted amount will be displayed based on real-time exchange rates.'] },
    ...
    { name: 'Website Word Counter', description: 'Count the number of words on any webpage by entering its URL.', icon: 'Calculator', category: 'text', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Enter the full URL of the website.', 'Click "Count Words".', 'The tool will display the estimated total word count on the page.'] },
    { name: 'Favicon Checker', description: 'Check if a website has a favicon and preview what it looks like.', icon: 'Heart', category: 'dev', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Enter the full URL of the website.', 'Click "Check Favicon".', 'The tool will display the favicon if it exists.'] },
    { name: 'Meta Tag Generator', description: 'Generate meta tags for your website to improve SEO and social media sharing.', icon: 'Code', category: 'seo', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Enter your site title and description.', 'The tool will generate the appropriate HTML meta tags.', 'Copy the generated code and paste it into the `<head>` section of your HTML.'] },
    { name: 'Keyword Density Checker', description: 'Analyze the keyword density of your text to optimize for SEO.', icon: 'PieChart', category: 'seo', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Paste your article or text into the text area.', 'Click "Analyze Text".', 'The tool will show you the most frequent keywords and their density.'] },
    { name: 'Redirect Checker', description: 'Check the redirect chain and status code of any URL.', icon: 'Link', category: 'seo', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Enter one or more URLs (one per line).', 'Click "Check Redirects".', 'View the full redirect path and final status code for each URL.'] },
    { name: 'SERP Checker', description: 'Check the search engine results page (SERP) for a specific keyword in any country.', icon: 'Search', category: 'seo', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Enter a keyword to search for.', 'Select the country for the search.', 'Optionally, enter your domain to see if it ranks.', 'Click "Check Rankings" to see the top results.'] },
    { name: 'Schema Generator', description: 'Generate structured data markup in JSON-LD format, including FAQ, Article, and Product schemas.', icon: 'FileJson', category: 'seo', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Select the schema type you want to create (e.g., FAQ).', 'Fill in the required fields for that schema type.', 'Click "Generate Schema".', 'Copy the generated JSON-LD code.'] },
    ...
    { name: 'Fuel Cost Calculator', description: 'Estimate the fuel cost for a trip based on distance, fuel efficiency, and price.', icon: 'Fuel', category: 'calculator', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Enter the trip distance, your vehicle\'s fuel efficiency, and the current fuel price.', 'Click "Calculate Fuel Cost".', 'The tool will display the total estimated cost for your trip.'] },
    { name: 'Time Zone Converter', description: 'Convert times between different time zones around the world.', icon: 'Clock', category: 'calculator', plan: 'Free', isNew: true, status: 'Active', howToUse: ['The tool shows the current time in several default time zones.', 'You can add more time zones from the dropdown list.', 'The times update automatically every second.'] },
    { name: 'Title Tag Checker', description: 'Check the length of your title tag in pixels and characters for SEO.', icon: 'Text', category: 'seo', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Enter your proposed title tag in the input field.', 'The tool will instantly show you the character count and estimated pixel width.', 'View the preview of how it might look on a Google search results page.'] },
    ...
    { name: 'SQL Formatter', description: 'Format and beautify your SQL queries for better readability.', icon: 'Database', category: 'dev', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Paste your unformatted SQL query.', 'Select your SQL dialect and indentation preferences.', 'Click "Format SQL" to see the beautified query.'] },
    { name: 'Word to PDF', description: 'Convert Microsoft Word documents to PDF format.', icon: 'FileText', category: 'pdf', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Upload your Word document (.doc or .docx).', 'The tool will automatically convert it to PDF.', 'Click "Download PDF" to save your new file.'] },
    { name: 'PDF to JPG', description: 'Convert PDF pages to high-quality JPG images.', icon: 'FileImage', category: 'pdf', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Upload your PDF file.', 'Select which pages you want to convert.', 'Choose the image quality.', 'Download the converted JPG images as a ZIP file.'] },
    { name: 'PDF to Word', description: 'Convert PDF documents to editable Microsoft Word files.', icon: 'FileText', category: 'pdf', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Upload your PDF file.', 'Click "Convert to Word".', 'The tool will process the file and provide a downloadable .docx file.'] },
    { name: 'Morse to Text Translator', description: 'Translate Morse code back into readable text.', icon: 'MessageSquare', category: 'miscellaneous', isNew: true, status: 'Active', howToUse: ['Enter Morse code using dots (.), dashes (-), and slashes (/) for spaces.', 'The translated text will appear automatically.', 'Use the "Play Sound" button to hear the Morse code audio.'] },
    { name: 'Text Encryption and Decryption', description: 'Encrypt and decrypt your text using various algorithms for security.', icon: 'Key', category: 'dev', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Enter the text you want to process.', 'Provide a secret key or password.', 'Choose whether to encrypt or decrypt.', 'The result will be displayed in the output box.'] },
    { name: 'GPA to Percentage Converter', description: 'Convert your GPA score back into a percentage.', icon: 'Calculator', category: 'calculator', isNew: true, status: 'Active', howToUse: ['Enter your GPA.', 'Select your university or enter a custom conversion formula.', 'The tool will display the equivalent percentage.'] },
    { name: 'PPT to PDF', description: 'Convert PowerPoint presentations to PDF.', icon: 'FileText', category: 'pdf', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Upload your PowerPoint file (.ppt or .pptx).', 'The file will be converted to PDF.', 'Download your new PDF file.'] },
    { name: 'Text to Morse Code', description: 'Convert text to Morse code.', icon: 'MessageSquare', category: 'miscellaneous', isNew: true, status: 'Active', howToUse: ['Enter the text you want to convert.', 'The corresponding Morse code will appear automatically.', 'Use the "Play Sound" button to hear the generated Morse code.'] },
    { name: 'Credit Card Interest Calculator', description: 'Calculate the interest on your credit card balance.', icon: 'CreditCard', category: 'calculator', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Enter your credit card balance, APR, and your planned monthly payment.', 'The tool will show you how long it will take to pay off and the total interest paid.', 'You can also see an amortization schedule.'] },
];
