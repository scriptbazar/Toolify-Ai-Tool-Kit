...
const initialTools: Omit<Tool, 'id' | 'slug' | 'createdAt'>[] = [
    ...
    { name: 'Excel to PDF', description: '📄 Convert your Microsoft Excel spreadsheets (.xls, .xlsx) into professional-looking, universally shareable PDF documents.', icon: 'FileSpreadsheet', category: 'pdf', plan: 'Free', isNew: true, status: 'Coming Soon', howToUse: ['Upload your Excel file (.xls or .xlsx).', 'The tool will automatically convert it to a PDF.', 'Click the "Download PDF" button to save your file.'] },
    ...
    { name: 'Word to PDF', description: '📄 Convert Microsoft Word documents (.doc, .docx) to high-quality PDF format.', icon: 'FileText', category: 'pdf', plan: 'Free', isNew: true, status: 'Coming Soon', howToUse: ['Upload your Word document (.doc or .docx).', 'The tool will automatically convert it to PDF.', 'Click "Download PDF" to save your new file.'] },
    ...
    { name: 'Morse to Text Translator', description: '💬 Translate Morse code back into readable text and hear the sound of the Morse code audio.', icon: 'MessageSquare', plan: 'Free', isNew: true, category: 'miscellaneous', howToUse: ['Enter Morse code using dots (.), dashes (-), and slashes (/) for spaces.', 'The translated text will appear automatically.', 'Use the "Play Sound" button to hear the Morse code audio.'] },
    ...
    { name: 'PPT to PDF', description: '📄 Convert PowerPoint presentations (.ppt, .pptx) to PDF format.', icon: 'FileText', category: 'pdf', plan: 'Free', isNew: true, status: 'Coming Soon', howToUse: ['Upload your PowerPoint file (.ppt or .pptx).', 'The file will be converted to PDF.', 'Download your new PDF file.'] },
