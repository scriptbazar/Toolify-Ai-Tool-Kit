...
const initialTools: Omit<Tool, 'id' | 'slug' | 'createdAt'>[] = [
    ...
    { name: 'Base64 Encoder/Decoder', description: 'Encode text to Base64 and decode from Base64 format, essential for data transmission and web development.', icon: 'Package', category: 'dev', plan: 'Free', isNew: true, status: 'Active' },
