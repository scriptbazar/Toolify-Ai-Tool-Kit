...
const initialTools: Omit<Tool, 'id' | 'slug' | 'createdAt'>[] = [
    ...
    { name: 'Lorem Ipsum Generator', description: '📄 Generate customizable placeholder text (Lorem Ipsum) in various lengths and formats. Ideal for web designers, developers, and print layout artists to visualize content flow.', icon: 'FileText', category: 'text', plan: 'Free', isNew: false, status: 'Active', howToUse: ['Select the type of text to generate (paragraphs, sentences, or words).', 'Enter the amount you wish to generate.', 'Click the "Generate" button to see the result.'] },
    ...
    { name: 'Text to Speech', description: '🗣️ Convert written text into natural-sounding spoken audio. Choose from a variety of voices and languages to bring your text to life for podcasts, videos, or accessibility.', icon: 'Volume2', category: 'ai', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Enter the text you want to convert into the text area.', 'Select the desired voice gender and model.', 'Click the "Generate Audio" button.', 'Listen to the generated audio directly on the page.'] },
    { name: 'Speech to Text', description: '🎙️ Accurately transcribe audio files and spoken words into written text. Perfect for interviews, meetings, and lecture notes, powered by advanced speech recognition.', icon: 'Voicemail', category: 'ai', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Upload your audio or video file (MP3, WAV, MP4, etc.).', 'Click the "Transcribe Audio" button.', 'Wait for the AI to process the file.', 'The transcribed text will appear in the text box below.'] },
    ...
    { name: 'Prompt Generator', description: '💡 Generate creative and detailed prompts for AI models. Turn a simple topic into a comprehensive prompt to get better results from AI image generators, writers, and more.', icon: 'Lightbulb', category: 'ai', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Enter a simple topic or a few keywords.', 'Select a category (e.g., Image, Website, Creative Writing).', 'Choose the desired style and level of detail.', 'Click "Generate Advanced Prompt" to get a comprehensive prompt.'] },
    { name: 'JSON Prompt Generator', description: '💻 Generate detailed, structured prompts in JSON format. Ensure consistent and predictable AI outputs for automated workflows and advanced applications.', icon: 'Braces', category: 'ai', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Enter a topic or keywords.', 'Select a category (e.g., Image, App).', 'Choose the style and detail level.', 'Click "Generate JSON Prompt" to get a structured JSON prompt.'] },
    { name: 'AI Blog Post Writer', description: '✍️ Generate a complete, SEO-friendly blog post on any topic. Includes headings, paragraphs, and a structure that is ready to be published.', icon: 'PenSquare', category: 'ai', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Enter the topic of your blog post.', 'Select the desired length, tone, and language.', 'Click "Generate Post".', 'The AI will write a complete blog post, which you can preview and copy.'] },
    { name: 'AI Content Summarizer', description: '📚 Summarize long articles, documents, or complex texts into concise, easy-to-read key points. Choose from short, medium, or detailed summary formats.', icon: 'AlignLeft', category: 'ai', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Paste the text you want to summarize into the input box.', 'Choose your desired summary format (Short, Medium, or Detailed).', 'Click the "Summarize" button.', 'The AI-generated summary will appear in the output box.'] },
    { name: 'AI Code Assistant', description: '🤖 Get an expert-level analysis of any code snippet. Includes language detection, summary, performance (Big O), security vulnerabilities, and improvement suggestions.', icon: 'Code', category: 'ai', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Paste your code into the text area.', 'Click "Analyze Code".', 'The AI will provide a detailed, multi-faceted analysis of its purpose, structure, performance, and security.'] },
    { name: 'AI Email Composer', description: '📧 Generate professional and effective emails for various purposes. Just provide key points and a desired tone, and let the AI draft the perfect message.', icon: 'Mail', category: 'ai', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Enter the subject of your email.', 'Select the desired tone of voice.', 'List the key points or message you want to convey.', 'Click "Generate Email" to get a complete email body drafted by AI.'] },
    { name: 'AI Product Description Writer', description: '🛒 Craft persuasive and engaging descriptions for your e-commerce products. Boost sales and improve your SEO with benefit-oriented copy.', icon: 'ShoppingCart', category: 'ai', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Enter the name of your product.', 'Describe the target audience.', 'Select the desired tone and format.', 'Click "Generate Description" to get SEO-friendly copy.'] },
    { name: 'AI Story Generator', description: '📖 Craft compelling and imaginative short stories in various genres from a simple prompt or topic. Perfect for writers, game developers, or creative minds.', icon: 'BookOpen', category: 'ai', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Enter a topic or a short prompt for your story.', 'Choose the genre and language.', 'Click the "Generate Story" button.', 'The AI will write a complete story for you.'] },
    { name: 'AI Tweet Generator', description: '🐦 Generate engaging tweets and thread ideas for your social media. Includes relevant hashtags to maximize reach and engagement.', icon: 'Twitter', category: 'ai', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Enter the topic you want to tweet about.', 'Select the desired tone for your tweet.', 'Click "Generate Tweet".', 'The AI will create a tweet with relevant hashtags, ready to be posted.'] },
    { name: 'AI Story Visualizer', description: '🎬 Analyze your story scene-by-scene and generate powerful, descriptive image prompts. Perfect for authors and screenwriters to visualize their narrative.', icon: 'Clapperboard', category: 'ai', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Paste your story or a chapter into the text area.', 'Click "Generate Scene Prompts".', 'The AI will break down your story into scenes and create detailed image prompts for each one.', 'Copy the prompts to use in an AI image generator.'] },
    { name: 'AI Rewriter', description: '✍️ Rewrite your text to improve clarity, change the tone, fix grammar, or adjust the length. A versatile tool for writers, marketers, and students.', icon: 'FilePenLine', category: 'ai', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Paste your original text into the input box.', 'Select your goal (e.g., Improve Clarity, Make it Formal).', 'Click the "Rewrite" button.', 'The rewritten text will appear in the output box.'] },
    { name: 'Add Watermark to PDF', description: '🛡️ Add a text or image watermark to your PDF documents. Protect your intellectual property and brand your files with customizable options.', icon: 'Fingerprint', category: 'pdf', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Upload the PDF file you want to watermark.', 'Choose between a text or image watermark.', 'Configure the watermark\'s text/image, opacity, size, and rotation.', 'Click "Apply Watermark & Download" to get your protected PDF.'] },
    ...
    { name: 'HTML Minifier', description: '⚡ Optimize your web pages by reducing the size of your HTML code. This helps improve load times and reduce bandwidth usage.', icon: 'FileCode', category: 'dev', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Paste your HTML code into the "Original HTML" box.', 'Click the "Minify HTML" button.', 'The minified code will appear in the "Minified HTML" box.', 'Click "Copy" to use the minified code.'] },
    ...
    { name: 'Interest Calculator', description: '📈 Calculate simple and compound interest for investments or loans. Understand the growth of your money or the cost of borrowing over time.', icon: 'Percent', category: 'calculator', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Select simple or compound interest.', 'Enter principal, rate, and time.', 'Set compounding frequency for compound interest.', 'View the calculated interest and total amount.'] },
    ...
    { name: 'YouTube Channel Banner Downloader', description: '🖼️ Download the high-quality banner image (channel art) from any YouTube channel in its best available resolution.', icon: 'Download', category: 'video', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Paste the URL of a YouTube channel.', 'Click "Download Banner".', 'The highest resolution banner will be downloaded.'] },
    { name: 'YouTube Channel Logo Downloader', description: '🖼️ Download the high-resolution profile picture or logo from any YouTube channel. Perfect for design work or analysis.', icon: 'Download', category: 'video', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Paste the URL of a YouTube channel.', 'Click "Download Logo".', 'The highest resolution profile picture will be downloaded.'] },
    { name: 'YouTube Video Description Extractor', description: '📝 Extract and view the full, formatted text description of any YouTube video. Easily copy links, timestamps, and other information.', icon: 'FileText', category: 'video', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Paste the URL of a YouTube video.', 'Click "Extract Description".', 'The full video description will be displayed for you to copy.'] },
    { name: 'YouTube Video Title Extractor', description: '🏷️ Quickly extract the complete, exact title from any YouTube video by pasting its URL. Useful for research and content creation.', icon: 'FileText', category: 'video', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Paste the URL of a YouTube video.', 'Click "Extract Title".', 'The video\'s full title will be displayed.'] },
    { name: 'YouTube Video Thumbnail Downloader', description: '🖼️ Download thumbnails from any YouTube video in all available resolutions (HD, SD, etc.). A must-have for content creators and marketers.', icon: 'Image', category: 'video', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Paste the URL of a YouTube video.', 'The tool will display all available thumbnail resolutions (HD, SD, default).', 'Click on the desired resolution to download the thumbnail image.'] },
    ...
    { name: 'PRN to PDF', description: '📄 Convert PRN files, commonly generated by the "Print to File" option, into standard, viewable PDF documents.', icon: 'FileText', category: 'pdf', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Upload your PRN file.', 'Click "Convert to PDF".', 'Download the converted PDF file.'] },
    ...
    { name: 'AI Web Content Summarizer', description: '🌐 Summarize and explain the content of any public website or article by simply providing a URL. Get key takeaways, SEO insights, and a final verdict instantly.', icon: 'Globe', category: 'ai', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Paste the URL of the webpage or article you want to process.', 'Click the "Process URL" button.', 'The AI will provide both a concise summary and a detailed explanation of the content.'] },
    ...
    { name: 'AI SEO Keyword Generator', description: '🔑 Get a comprehensive list of primary, secondary, and long-tail keywords for any topic. Boost your search engine ranking and content strategy.', icon: 'Key', category: 'seo', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Enter your main topic or keyword.', 'Optionally, specify your target audience.', 'Click "Generate Keywords".', 'The AI will provide lists of primary, secondary, and long-tail keywords.'] },
    { name: 'Website Word Counter', description: '📊 Count the number of words on any webpage by entering its URL. Useful for SEO analysis, content assessment, and competitive research.', icon: 'Calculator', category: 'text', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Enter the full URL of the website.', 'Click "Count Words".', 'The tool will display the estimated total word count on the page.'] },
    ...
    { name: 'Robots.txt Generator', description: '🤖 Create a `robots.txt` file to guide search engine crawlers on your website. Easily allow or disallow specific bots and directories.', icon: 'FileCode', category: 'seo', plan: 'Pro', isNew: true, status: 'Active', howToUse: ["The editor comes with a default robots.txt template.", "Modify the content as needed for your specific site structure.", "Click 'Copy Code' to get the content for your robots.txt file."] },
    ...
    { name: 'SQL Formatter', description: '🗃️ Format and beautify your SQL queries for better readability. Supports various SQL dialects and indentation preferences.', icon: 'Database', category: 'dev', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Paste your unformatted SQL query.', 'Select your SQL dialect and indentation preferences.', 'Click "Format SQL" to see the beautified query.'] },
