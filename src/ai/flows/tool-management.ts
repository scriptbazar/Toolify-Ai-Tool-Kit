...
const initialTools: Omit<Tool, 'id' | 'slug' | 'createdAt'>[] = [
    ...
    { name: 'HTML Minifier', description: '⚡ Optimize your web pages by reducing the size of your HTML code. This helps improve load times and reduce bandwidth usage.', icon: 'FileCode', category: 'dev', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Paste your HTML code in the input box.', 'Click the "Minify HTML" button.', 'The minified code will be displayed in the output box.'] },
    ...
    { name: 'Text Recognizer', description: '📄 Extract and analyze text from any image using advanced Optical Character Recognition (OCR). View text by blocks, words, or symbols.', icon: 'ScanText', category: 'ai', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Upload an image containing text.', 'The AI will analyze the image and display the full text.', 'Use the tabs to view text broken down by blocks, paragraphs, and words.'] },
