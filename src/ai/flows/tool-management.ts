...
const initialTools: Omit<Tool, 'id' | 'slug' | 'createdAt'>[] = [
    ...
    { name: 'Age Calculator', description: '🎂 Calculate your exact age in years, months, and days from your date of birth instantly. Also shows the countdown to your next birthday.', icon: 'Gift', category: 'calculator', plan: 'Free', isNew: false, status: 'Active', howToUse: ['Select your date of birth using the calendar.', 'The tool will automatically calculate and display your age in years, months, and days.', 'It will also show how many days are left until your next birthday.'] },
    ...
    { name: 'Rotate PDF', description: '🔄 Rotate all pages or specific pages in your PDF document to the correct orientation. Fix incorrectly scanned or oriented documents with ease.', icon: 'RotateCw', category: 'pdf', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Upload your PDF file.', 'Select whether to rotate all pages or specific pages.', 'Choose the rotation angle (90, 180, or 270 degrees).', 'Click "Rotate & Download" to get the updated PDF.'] },
    { name: 'Marks To Percentage Calculator', description: '🎓 Convert your exam marks or grades into a standardized percentage score quickly and easily. Useful for students applying for admissions or jobs.', icon: 'Calculator', category: 'calculator', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Enter the marks you obtained.', 'Enter the total possible marks for the exam.', 'Click "Calculate Percentage".', 'The tool will display your percentage score.'] },
    ...
    { name: 'Percentage To CGPA Converter', description: '🎓 Convert your overall percentage into a CGPA score on various scales (e.g., 4.0, 10.0). Essential for applications and academic records.', icon: 'Calculator', category: 'calculator', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Enter your total percentage.', 'Select the target CGPA scale (e.g., 10-point scale).', 'Click "Convert to CGPA".', 'Your equivalent CGPA will be displayed.'] },
    ...
    { name: 'PDF Page Reorder', description: '🔄 Visually rearrange the pages of your PDF document into a new order with a simple drag-and-drop interface. Organize your reports and presentations perfectly.', icon: 'Shuffle', category: 'pdf', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Upload your PDF file.', 'Thumbnails of all pages will be displayed.', 'Drag and drop the page thumbnails into your desired new order.', 'Click "Save & Download" to get the reordered PDF.'] },
    ...
    { name: 'PDF Page Numberer', description: '#️⃣ Add customizable page numbers to your PDF documents. Choose position, format, and style to professionalize your files.', icon: 'Hash', category: 'pdf', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Upload your PDF file.', 'Choose the position for the page numbers (e.g., bottom center).', 'Select the format and starting number.', 'Click "Add Numbers & Download" to get your numbered PDF.'] },
    { name: 'PDF Page Remover', description: '🗑️ Delete one or more specific pages from a PDF document. Create a new, refined file by removing unnecessary or sensitive pages.', icon: 'FileMinus', category: 'pdf', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Upload your PDF file.', 'Enter the page numbers you want to delete (e.g., "2, 5-7").', 'Click "Remove Pages & Download".', 'A new PDF without the specified pages will be downloaded.'] },
    { name: 'PDF Organizer', description: '🗂️ Visually rearrange, delete, rotate, and organize pages from multiple PDF files into one new, coherent document. The ultimate PDF management tool.', icon: 'Layers', category: 'pdf', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Upload one or more PDF files.', 'Drag, rotate, or delete page thumbnails from all documents.', 'Arrange them in the desired final order.', 'Click "Create PDF" to merge and download your new document.'] },
    ...
    { name: 'Currency Converter', description: '💱 Convert between different world currencies with up-to-date exchange rates. Essential for travel, online shopping, and business.', icon: 'Coins', category: 'calculator', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Enter the amount you wish to convert.', 'Select the "From" and "To" currencies from the dropdown lists.', 'The converted amount will be displayed based on real-time exchange rates.'] },
    ...
    { name: 'Keyword Density Checker', description: '📈 Analyze the keyword density of your text to optimize for SEO. Find out which terms appear most frequently in your content.', icon: 'PieChart', category: 'seo', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Paste your article or text into the text area.', 'Click "Analyze Text".', 'The tool will show you the most frequent keywords and their density.'] },
    { name: 'Redirect Checker', description: '🔗 Check the full redirect chain and status code (301, 302, etc.) of any URL. An essential tool for SEO audits and link management.', icon: 'Link', category: 'seo', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Enter one or more URLs (one per line).', 'Click "Check Redirects".', 'View the full redirect path and final status code for each URL.'] },
    { name: 'SERP Checker', description: '🔍 Check the search engine results page (SERP) for a specific keyword in any country. See who is ranking and where your domain appears.', icon: 'Search', category: 'seo', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Enter a keyword to search for.', 'Select the country for the search.', 'Optionally, enter your domain to see if it ranks.', 'Click "Check Rankings" to see the top results.'] },
    { name: 'Robots Txt Generator', description: '🤖 Create a robots.txt file to guide search engine crawlers. Set rules for different bots and include your sitemap easily. This tool provides a user-friendly interface to build your robots.txt file, helping you control how search engines interact with your site, which is crucial for SEO.', icon: 'FileCode', category: 'seo', plan: 'Free', isNew: true, status: 'Active', howToUse: ["Select a default policy (Allow or Block all).", "Add specific rules for different user-agents (e.g., Googlebot).", "Enter the full URL to your sitemap.", "The robots.txt content is generated live for you to copy or download."] },
    ...
    { name: 'Word to PDF', description: '📄 Convert Microsoft Word documents (.doc, .docx) to high-quality PDF format. Preserve your formatting and share your documents universally.', icon: 'FileText', category: 'pdf', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Upload your Word document (.doc or .docx).', 'The tool will automatically convert it to PDF.', 'Click "Download PDF" to save your new file.'] },
    { name: 'PDF to JPG', description: '🖼️ Convert each page of a PDF document into a high-quality JPG image. Download individual images or a ZIP file of all pages.', icon: 'FileImage', category: 'pdf', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Upload your PDF file.', 'Select which pages you want to convert.', 'Choose the image quality.', 'Download the converted JPG images as a ZIP file.'] },
    { name: 'PDF to Word', description: '✍️ Convert PDF documents to editable Microsoft Word files (.docx). Retains formatting to make editing easy.', icon: 'FileText', category: 'pdf', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Upload your PDF file.', 'Click "Convert to Word".', 'The tool will process the file and provide a downloadable .docx file.'] },
    ...
    { name: 'Credit Card Interest Calculator', description: '💳 Calculate the interest on your credit card balance and see how long it will take to pay it off. An essential tool for financial planning.', icon: 'CreditCard', category: 'calculator', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Enter your credit card balance, APR, and your planned monthly payment.', 'The tool will show you how long it will take to pay off and the total interest paid.', 'You can also see an amortization schedule.'] },
    ...
    { name: 'Schema Generator', description: '🧾 Generate structured data markup in JSON-LD format. Create FAQ, Article, and Product schemas to enhance your search engine listings.', icon: 'FileJson', category: 'seo', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Select the schema type you want to create (e.g., FAQ).', 'Fill in the required fields for that schema type.', 'Click "Generate Schema".', 'Copy the generated JSON-LD code.'] },
    { name: 'Crontab Generator', description: '⏰ Interactively generate Crontab expressions for scheduling tasks. A simple way to create complex cron jobs without memorizing the syntax.', icon: 'Clock', category: 'dev', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Use the dropdowns to select the minute, hour, day, month, and day of the week.', 'As you make selections, the cron expression and a human-readable description are updated in real-time.', 'Copy the generated expression for use in your server.'] },
    { name: 'HTML to Markdown Converter', description: '🔄 Convert HTML code into clean, readable Markdown format. Paste your HTML and get the equivalent Markdown instantly.', icon: 'FileCode', category: 'dev', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Paste your HTML code into the input box.', 'The converted Markdown will appear in the output box automatically.', 'Copy the Markdown for use in your documents or applications.'] },
    ...
    { name: 'Readability Score Checker', description: '📝 Analyze your text to determine its readability score using the Flesch-Kincaid formula. Improve your content for better engagement.', icon: 'BookOpen', category: 'text', plan: 'Free', isNew: true, status: 'Active', howToUse: ['Paste your text into the input area.', 'The tool will instantly calculate the readability score and grade level.', 'Use the feedback to simplify your writing.'] },
    { name: 'Profit Loss Calculator', description: 'Calculate profit or loss from cost and selling price.', icon: 'Calculator', category: 'calculator', plan: 'Free', isNew: true, status: 'Active' },
    { name: 'SIP Calculator', description: 'Calculate the future value of your SIP investments.', icon: 'TrendingUp', category: 'calculator', plan: 'Free', isNew: true, status: 'Active' },
    { name: 'FD Calculator', description: 'Calculate the maturity amount of your Fixed Deposit.', icon: 'CalendarDays', category: 'calculator', plan: 'Free', isNew: true, status: 'Active' },
    { name: 'Mutual Fund Calculator', description: 'Estimate the returns on your mutual fund investments.', icon: 'PieChart', category: 'calculator', plan: 'Free', isNew: true, status: 'Active' },
    ...
    { name: 'Internet Speed Tester', description: 'Test your internet connection speed.', icon: 'Gauge', category: 'miscellaneous', plan: 'Free', isNew: true, status: 'Active' },
    { name: 'Website Word Counter', description: 'Check the size of any webpage.', icon: 'FileSearch', category: 'seo', plan: 'Free', isNew: true, status: 'Active' },
    { name: 'Device Information Detector', description: 'Get detailed information about your device.', icon: 'Smartphone', category: 'dev', plan: 'Free', isNew: true, status: 'Active' },
    { name: 'Numbers to Word', description: 'Convert numbers into words.', icon: 'CaseUpper', category: 'text', plan: 'Free', isNew: true, status: 'Active' },
    { name: 'Emoji Remover', description: 'Remove all emojis from your text.', icon: 'Eraser', category: 'text', plan: 'Free', isNew: true, status: 'Active' },
    { name: 'Roman to Number Converter', description: 'Convert Roman numerals to numbers.', icon: 'Hash', category: 'calculator', plan: 'Free', isNew: true, status: 'Active' },
    ...
    { name: 'Loan Affordability Calculator', description: 'Determine how much loan you can afford based on your income and expenses.', icon: 'Banknote', category: 'calculator', plan: 'Free', isNew: true, status: 'Active' },
