...
const initialTools: Omit<Tool, 'id' | 'slug' | 'createdAt'>[] = [
    ...
    { name: 'Credit Card Interest Calculator', description: 'Calculate your loan payments, total interest, and amortization schedule for various loan types.', icon: 'Landmark', category: 'calculator', plan: 'Pro', isNew: true, status: 'Active', howToUse: ['Enter your loan amount, interest rate, and term.', 'Optionally, add GST and select payment frequency.', 'Click "Calculate" to see your EMI and a full breakdown.', 'Download your amortization schedule as a PDF.'] },
