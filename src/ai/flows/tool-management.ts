...
const initialTools: Omit<Tool, 'id' | 'slug' | 'createdAt'>[] = [
    ...
    { name: 'Myntra Shipping Label Cropper', description: 'Crop Myntra shipping labels to 4x6 size.', icon: 'Crop', category: 'ecommerce', plan: 'Free', isNew: true, status: 'Active' },
    { name: 'Flipkart Shipping Label Cropper', description: 'Crop Flipkart shipping labels to 4x6 size.', icon: 'Crop', category: 'ecommerce', plan: 'Free', isNew: true, status: 'Active' },
    { name: 'Meesho Shipping Label Cropper', description: 'Crop Meesho shipping labels to 4x6 size.', icon: 'Crop', category: 'ecommerce', plan: 'Free', isNew: true, status: 'Active' },
