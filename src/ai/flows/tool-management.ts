...
const initialTools: Omit<Tool, 'id' | 'slug' | 'createdAt'>[] = [
    ...
    { name: 'AI Code Assistant', description: 'Get a complete analysis of any code snippet, including language detection, summary, and improvement suggestions.', icon: 'Code', category: 'ai', plan: 'Pro', isNew: true, isToolOfTheWeek: false, status: 'Active', howToUse: ['Paste your code into the text area.', 'Click "Analyze Code".', 'The AI will identify the language and provide a detailed analysis of its purpose, structure, and potential improvements.'] },
