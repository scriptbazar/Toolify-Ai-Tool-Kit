...
const initialTools: Omit<Tool, 'id' | 'slug' | 'createdAt'>[] = [
    ...
    { name: 'SIP Calculator', description: 'Calculate the future value of your SIP investments.', icon: 'TrendingUp', category: 'calculator', plan: 'Pro', isNew: true, status: 'Active' },
    ...
    { name: 'Mutual Fund Calculator', description: 'Estimate the returns on your mutual fund investments.', icon: 'PieChart', category: 'calculator', plan: 'Pro', isNew: true, status: 'Active' },
    ...
    { name: 'Spelling Checker', description: 'Check and correct spelling in your text.', icon: 'SpellCheck', category: 'text', plan: 'Pro', isNew: true, status: 'Active' },
    ...
    { name: 'Website Word Counter', description: 'Check the size of any webpage.', icon: 'FileSearch', category: 'seo', plan: 'Pro', isNew: true, status: 'Active' },
    ...
    { name: 'RD Calculator', description: 'Calculate the maturity amount of your Recurring Deposit.', icon: 'Repeat', category: 'calculator', plan: 'Pro', isNew: true, status: 'Active' },
    { name: 'NPS Calculator', description: 'Calculate the future value of your National Pension Scheme investments.', icon: 'Landmark', category: 'calculator', plan: 'Pro', isNew: true, status: 'Active' },
